...
servername = " "
players = ("0", "0")
icon = Image.open("motd-to-img/resources/images/server_default_icon.png")
img = Image.open("motd-to-img/resources/images/mcserverbackground.png")
draw = ImageDraw.Draw(img)
fontreg = ImageFont.truetype("motd-to-img/resources/fonts/McFontRegular.otf", 20)
fontbold = ImageFont.truetype("motd-to-img/resources/fonts/McFontBold.otf", 20)
fontitalic = ImageFont.truetype("motd-to-img/resources/fonts/McFontItalic.otf", 20)
fontboldanditalic = ImageFont.truetype("motd-to-img/resources/fonts/McFontBoldItalic.otf", 20)
draw.fontmode = "1"
