  ...
  run: async (client, interaction) => {
    ...
    await modalInteraction.reply({
      embeds: [
        ...
        new ActionRowBuilder().setComponents(
          new ButtonBuilder().setCustomId('preview_brief').
            setLabel('Preview Mission Brief').
            setStyle(1),
