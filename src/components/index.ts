...
import confessionDelete from './buttons/confession_delete';
...
export const components: ComponentHandler[] = [confessionDelete, previewBrief, resetWarnsNo, resetWarnsYes, sendBrief, confessModal];
